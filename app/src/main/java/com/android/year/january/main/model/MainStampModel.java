...
public class MainStampModel implements CursorModel {
    ...
    public MainStampModel(String mTitle, String mContent, String mAuthor, String mColor) {
    ...
    public MainStampModel(String mTitle, String mContent, String mColor) {
