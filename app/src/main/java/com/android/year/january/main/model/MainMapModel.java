...
public class MainMapModel implements CursorModel {
    ...
    public MainMapModel(String mTitle, String mContent, String mAuthor, String mColor) {
    ...
    public MainMapModel(String mTitle, String mContent, String mColor) {
